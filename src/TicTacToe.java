...
private void initComponents() {
    ...
    frame=new JFrame("Exit");
        ...
        if(jbtnexit.getText()=="Start Game") {
            ...
            if(JOptionPane.showConfirmDialog(frame,"Do you want to Play first?","Tic Tac Toe",JOptionPane.YES_NO_OPTION)== JOptionPane.YES_NO_OPTION)
                h=1;
            if(h==0) {
                gamec(0);
            }
            ...
            if(JOptionPane.showConfirmDialog(frame,"Confirm if you want to Exit the Game","Tic Tac Toe",JOptionPane.YES_NO_OPTION)== JOptionPane.YES_NO_OPTION)
            {
                System.exit(0);
            }
        }
...
public static int PossWin(@SuppressWarnings("rawtypes") List l) {
